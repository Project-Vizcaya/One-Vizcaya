...
import { collection, getDocs, doc, updateDoc, query, orderBy, type Timestamp } from 'firebase/firestore'
...
export function useUsers() {
  ...
  const updateRole = useMutation({
    mutationFn: ({ userId, role, municipality }: { userId: string; role: string; municipality?: string }) => {
